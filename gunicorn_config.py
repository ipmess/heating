...
raw_env = [
    ...
    'SPAM=eggs',
    'SECRET_KEY=b58d0e34a0d35dc32a258235d2d143c65f859453bac510a0e2ee0296077fbe0f',
]
pidfile = None
umask = 0
user = None
...
# Pulled from https://developers.redhat.com/articles/2023/08/17/how-deploy-flask-application-python-gunicorn#the_application :
